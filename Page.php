...
abstract class Page
{
    ...
    {
        $this->_database = new mysqli('localhost', 'root', '', 'pizza');
  ...
  <div class="jumbotron" style="margin-bottom:0px">
    <h1>Pizzeria Da Salvo Online Bestellung</h1>
    <p>
      Bestellen Sie bei der besten Pizza in Mainz
    </p>
  </div>
  ...
  <div class="collapse navbar-collapse" id="collapse_target">
      ...
      <ul class="navbar-nav">
        ...
        <li class"nav-item"><a class="nav-link" href="Speisekarte.php">Speisekarte</a></li>
        <li class"nav-item"><a class="nav-link" href="Kunde.php">Kunde</a></li>
        <li class"nav-item"><a class="nav-link" href="Baecker.php">Baecker</a></li>
        <li class"nav-item"><a class="nav-link" href="Fahrer.php">Fahrer</a></li>
